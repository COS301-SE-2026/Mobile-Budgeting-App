...
| QR-02 | Error rate stays below 1% at peak load                                              | Connection pooling sized against RDS max connections; stateless containers (no shared in-memory state to corrupt under concurrency)                                                                   | k6, same run as QR-01, tracking HTTP error codes                                                                                                                      | <1%                                |
