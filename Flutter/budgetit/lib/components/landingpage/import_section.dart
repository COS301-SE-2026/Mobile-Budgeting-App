  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        Column(
          children: [
            Container(height: 180, color: colours.primary),
        ...
        Positioned(
          top: -60,
          right: 40,
          child: _Circle(size: 130, color: colours.secondary),
        ),
        Positioned(
          top: 90,
          left: 60,
          child: _Circle(size: 110, color: colours.greenAccents),
        ),
