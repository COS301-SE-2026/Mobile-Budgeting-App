...
const Map<SignConvention, String> _kConventionLabels = {
  SignConvention.crSuffixMeansIncome:
      'CR suffix means income (unmarked = expense)',
  SignConvention.minusPrefixMeansExpense:
      '"-" means expense (unmarked = income)',
  ...
  SignConvention.explicitDebitMeansExpense:
      'Only Debit is marked; unmarked = income',
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<SignConvention>(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle: context.colours.b1.copyWith(
                          color: context.colours.secondary,
                        ),
