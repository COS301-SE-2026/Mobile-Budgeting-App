...
| ------   | ------     | ------                                                                                                                                                                                                          |
| **Demo 1**   | Foo        | <span id="shieldcn-demo1-progress-start"></span>![badge](https://shieldcn.dev/badge/Demo%201%20%3A%20-Completed-36F57C.png?logo=lu%3ACheck)<span id="shieldcn-demo1-progress-end"></span>                       |
| **Demo 2**   | Bar        | <span id="shieldcn-demo2-progress-start"></span>![badge](https://shieldcn.dev/badge/Demo%202%20%3A%20-In%20Progress%2010.00%25-F5DB36.png?logo=lu%3ALoaderCircle)<span id="shieldcn-demo2-progress-end"></span> |
| **Demo 3**   | Foo        | <span id="shieldcn-demo3-progress-start"></span>![badge](https://shieldcn.dev/badge/Demo%203%20%3A%20-Not%20Started-6e6e6e.png?logo=false)<span id="shieldcn-demo3-progress-end"></span>                        |
| **Demo 4**   | Bar        | <span id="shieldcn-demo4-progress-start"></span>![badge](https://shieldcn.dev/badge/Demo%204%20%3A%20-Not%20Started-6e6e6e.png?logo=false)<span id="shieldcn-demo4-progress-end"></span>                        |
...
| **Calls** | <span id="shieldcn-coverage-calls-start"></span>![badge](https://shieldcn.dev/badge/Calls-pending-6e6e6e.png)<span id="shieldcn-coverage-calls-end"></span> |
